...
import com.example.lab6.service.ProveedorService;
...
public class ProveedorController {
    ...
    public String mostrarFormularioCrear(Model model) {
        ...
        return "formularioProveedor"; // Vista para el formulario
    }
    ...
    public String guardarProveedor(@ModelAttribute Proveedor proveedor) {
        ...
        return "redirect:/proveedores"; // Redirigir a la lista después de guardar
    }
    ...
    public String mostrarFormularioEditar(@PathVariable Long id, Model model) {
        ...
        return "formularioProveedor"; // Vista para editar
    }
    ...
    public String eliminarProveedor(@PathVariable Long id) {
        service.eliminar(id);
        return "redirect:/proveedores"; // Redirigir después de eliminar
    }
}